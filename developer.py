...
class Developer:
    def __init__(self,root):
        ...
        img_top=Image.open(r"collegeimages\dev.jpg")
        ...
        main_frame.place(x=800,y=0,width=460,height=500)

        img_top1=Image.open(r"collegeimages\kiran.jpg")
        ...
        #Developer
        dev_label=Label(main_frame,text="Hello",font=("times new roman",13,"bold"),bg="white")
