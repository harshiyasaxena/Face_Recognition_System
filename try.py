...
class Try:
    def __init__(self,root):
        ...
        img3=img3.resize((15370,710),Image.ANTIALIAS)
        ...
        #left label frame
        Left_frame=LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="Student Attendance Details",font=("times new roman"))
        Left_frame.place(x=10,y=10,width=730,height=580)
        
        img_left=Image.open(r"C:\")
        ...
        left_inside_frame=Frame(Left_frame,bd=2,releif=RIDGE,bg="white")
        ...
        #right label frame
        Right_frame=LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="Attendance Details",font=("times new roman"))
        Right_frame.place(x=750,y=10,width=720,height=580)

        table_frame=Frame(left_inside_frame,bd=2,relief=RIDGE,bg="white")
        ...
        self.AttendanceReportTable=ttk.Treeview(table_frame,column=("id","roll","name","department","time","date","attendance",xscrollcommand=scroll_x.set,ycrollcommand=scroll_y.set))
