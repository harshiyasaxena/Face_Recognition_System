...
class Attendance:
    def __init__(self,root):
        ...
        #first image
        img=Image.open(r"collegeimages\smart-attendance.jpg")
        ...
        #second image
        img1=Image.open(r"collegeimages\iStock-182059956_18390_t12.jpg")
        img1=img1.resize((600,150),Image.LANCZOS)
        self.photoimg1=ImageTk.PhotoImage(img1)
        
        f_lbl1=Label(self.root,image=self.photoimg1)
        f_lbl1.place(x=700,y=0,width=600,height=150)

                #background image
        img3=Image.open(r"C:\Users\harsh\OneDrive\Desktop\face_recognition_system-master\collegeimages\smart-attendance.jpg")
        img3=img3.resize((1400,1200),Image.LANCZOS)
        self.photoimg3=ImageTk.PhotoImage(img3)
        
        bg_img=Label(self.root,image=self.photoimg)
        bg_img.place(x=0,y=150,width=1400,height=1200)

       
        
        title_lbl=Label(bg_img,text="ATTENDANCE MANAGEMENT SYSTEM",font=("times new roman",35,"bold"),fg="green",bg="white")
        title_lbl.place(x=0,y=0,width=1400,height=45)
        
        main_frame=Frame(bg_img,bd=2,bg="white")
        main_frame.place(x=0,y=45,width=1400,height=600)
        ...
        img_left=Image.open(r"collegeimages\students.jpg")
        ...
        left_inside_frame.place(x=0,y=135,width=650,height=370)
        ...
        btn_frame.place(x=0,y=190,width=630,height=35)
        ...
        Right_frame.place(x=650,y=10,width=600,height=400)
