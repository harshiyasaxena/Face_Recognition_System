...
class Student:
    def __init__(self,root):
        ...
        img2=Image.open(r"collegeimages\iStock-182059956_18390_t12.jpg")
        ...
        bg_img.place(x=0,y=0,width=1400,height=1200)

        title_lbl=Label(bg_img,text="STUDENT MANAGEMENT SYSTEM",font=('times new roman',30,'bold'),fg='white',bg='blue')
        title_lbl.place(x=0,y=0,width=1400,height=45)

        main_frame=Frame(bg_img,bd=2,bg="white")
        main_frame.place(x=0,y=45,width=1400,height=700)

         #left label frame

        Left_frame=LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="Student Details",font=("times new roman",12,"bold"))
        Left_frame.place(x=0,y=0,width=1400,height=700)
 
         
        img_left=Image.open(r"collegeimages\u.jpg")
        ...
        Right_frame.place(x=700,y=0,width=740,height=580)
        
        
        img_right=Image.open(r"collegeimages\students.jpg")
    ...
    def add_data(self):
      if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="" :
        ...
        try:
            conn=mysql.connector.connect(host="localhost",username="root",password="Iamgreat123@",database="face_recognizer")
        ...
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="" :
           ...
           try:
              ...
              if Update>0:
                 conn=mysql.connector.connect(host="localhost",username="root",password="Iamgreat123@",database="face_recognizer")
                 my_cursor=conn.cursor()
                 my_cursor.execute("Update student set Dep=%s,Course=%s,Year=%s ,sem=%s,Name=%s,`Div`=%s,Roll=%s,Gender=%s,Dob=%s,Email=%s,Phone=%s,Address=%s,Teacher=%s,Photo=%s where id=%s", (
                                                                                                                                                                                                                 self.var_dep.get(),
                                                                                                                                                                                                                 self.var_course.get(),
                                                                                                                                                                                                                 self.var_year.get(),
                                                                                                                                                                                                                 self.var_semester.get(),
